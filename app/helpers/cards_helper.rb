module CardsHelper
  def card_style(card)
    styles = {
      ...
      "CASAS BAHIA" => { color: "#007BFF", rgb: "0, 123, 255",  logo: "creditcard.png",          flag: "visa.png" },
      "DIGIO" =>       { color: "#002F87", rgb: "0, 47, 135",   logo: "creditcard.png",          flag: "visa.png" },
      "OUTROS" =>      { color: "#0DCAF0", rgb: "13, 202, 240", logo: "creditcard.png",          flag: "" },
      "RENNER" =>      { color: "#000000", rgb: "0, 0, 0",      logo: "creditcard.png",          flag: "mastercard.png" },
      "WILL" =>        { color: "#FFC107", rgb: "255, 193, 7",  logo: "creditcard.png",          flag: "mastercard.png" },
      "PAN" =>         { color: "#17A2B8", rgb: "23, 162, 184", logo: "creditcard.png",          flag: "mastercard.png" },
